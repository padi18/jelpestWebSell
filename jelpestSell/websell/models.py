...
class Demo(models.Model):
    ...
    surnames = models.CharField(_("Apellidos"), max_length=100, db_column="surnames", null=False)
    ...
    day = models.DateField(_("Día"), auto_now=False, null=False, db_column="day")
    hour = models.TimeField(_("Hora"), auto_now=False, null=False, db_column="hour")
